    ...
    rules: [
      {
        id: createId(),
        active: true,
        conditions: [{ type: 'header', comparator: 'i;ascii-casemap', matchType: ':is', header: 'Subject', keys: ['[SPAM]'] }],
    ...
    rules: [
      {
        ...
        active: true,
        conditions: [
          { type: 'header', comparator: 'i;ascii-casemap', matchType: ':contains', header: 'Subject', keys: ['viagra', 'cialis', 'enlargement'] },
          { type: 'header', comparator: 'i;ascii-casemap', matchType: ':contains', header: 'From', keys: ['pharmacy', 'discount'] }
        ],
        actions: [{ type: 'fileinto', parameters: { mailbox: 'INBOX.Spam' } }],
        combinator: 'anyof'
      }
    ...
    rules: [
      {
        ...
        active: true,
        conditions: [
          { type: 'header', comparator: 'i;ascii-casemap', matchType: ':contains', header: 'Subject', keys: ['newsletter', 'weekly update', 'digest'] },
          { type: 'header', comparator: 'i;ascii-casemap', matchType: ':contains', header: 'From', keys: ['news@', 'newsletter@', 'noreply@', 'do-not-reply@'] }
        ],
    ...
    rules: [
      {
        ...
        active: true,
        conditions: [
          { type: 'address', comparator: 'i;ascii-casemap', matchType: ':is', addressPart: ':all', header: 'From', keys: ['boss@company.com', 'important@client.com'] }
        ],
        actions: [
    ...
    rules: [
      {
        ...
        active: true,
        conditions: [
          { type: 'header', comparator: 'i;ascii-casemap', matchType: ':matches', header: 'Content-Type', keys: ['*multipart/mixed*'] }
        ],
    ...
    rules: [
      {
        ...
        active: true,
        conditions: [
          { type: 'header', comparator: 'i;ascii-casemap', matchType: ':contains', header: 'Subject', keys: ['notification', 'alert', 'confirm', 'verify'] },
          { type: 'address', comparator: 'i;ascii-casemap', matchType: ':contains', addressPart: ':domain', header: 'From', keys: ['no-reply', 'noreply', 'donotreply'] }
        ],
    ...
    rules: [
      {
        ...
        active: true,
        conditions: [
          { type: 'address', comparator: 'i;ascii-casemap', matchType: ':contains', addressPart: ':domain', header: 'From', keys: ['company.com', 'work.org'] }
        ],
      ...
      },
      {
        ...
        active: true,
        conditions: [
          { type: 'address', comparator: 'i;ascii-casemap', matchType: ':contains', addressPart: ':domain', header: 'From', keys: ['gmail.com', 'outlook.com', 'yahoo.com', 'hotmail.com'] }
        ],
    ...
    rules: [
      {
        ...
        active: true,
        conditions: [
          { type: 'address', comparator: 'i;ascii-casemap', matchType: ':contains', addressPart: ':domain', header: 'From', keys: ['facebook.com', 'twitter.com', 'instagram.com', 'linkedin.com', 'pinterest.com'] }
        ],
    ...
    rules: [
      {
        ...
        active: true,
        conditions: [
          { type: 'address', comparator: 'i;ascii-casemap', matchType: ':contains', addressPart: ':domain', header: 'From', keys: ['important-client.com', 'partner.org'] }
        ],
        actions: [
    ...
    rules: [
      {
        ...
        active: true,
        conditions: [
          { type: 'header', comparator: 'i;ascii-casemap', matchType: ':contains', header: 'Subject', keys: ['report', 'newsletter', 'update'] }
        ],
...
const HelpTooltip = ({ text, children, position = "top" }) => {
  ...
  return (
      <div className="relative inline-flex items-center group">
        {children}
        <div className={`absolute ${positionClasses[position]} w-64 bg-gray-800 text-white text-xs rounded p-2 opacity-0 group-hover:opacity-100 transition pointer-events-none z-50`}>
          {text}
        </div>
      </div>
  );
...
const SieveEditor = () => {
  ...
  const addRule = useCallback(() => {
    setRules(prevRules => [...prevRules, {
      id: createId(),
      active: true,
      conditions: [{ type: 'header', comparator: 'i;ascii-casemap', matchType: ':is', header: 'Subject', keys: [''] }],
  ...
  const NotificationComponent = useMemo(() => {
    ...
    return (
        <div className={`fixed bottom-4 right-4 px-4 py-3 rounded border ${bgColor} flex items-center shadow-lg z-50`}>
          {icon}
        ...
        <div className="mb-6 bg-white rounded-lg shadow-sm p-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <label className="px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded flex items-center cursor-pointer">
                <input
                    ref={importFileRef}
                    type="file"
                    accept=".sieve,.txt"
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center">
                      ...
                      <HelpTooltip text={HELP_TEXT.rule}>
                        <button aria-label="Information about rules" className="ml-1 text-gray-400 hover:text-blue-500">
                              ...
                              <div className="mb-4">
                                <div className="flex justify-between items-center mb-2">
                                  <div className="flex items-center">
                                    <h4 className="font-medium">If {rule.conditions.length > 1 && (
                                        ...
                                        >
                                          {rule.combinator === 'anyof' ? 'any' : 'all'} of the following conditions
                                        </button>
                                    )}</h4>

                                    {rule.conditions.length > 1 && (
                                        <HelpTooltip text={rule.combinator === 'anyof' ? HELP_TEXT.anyof : HELP_TEXT.allof}>
                                          <button aria-label="Combinator information" className="ml-1 text-gray-400 hover:text-blue-500">
                                            <HelpCircle className="h-4 w-4" />
                                          </button>
                                        </HelpTooltip>
                                    )}
                                ...
                                <div className="space-y-2">
                                  {rule.conditions.map((condition, condIndex) => (
                                      <div key={condIndex} className="flex items-start space-x-2 bg-gray-50 p-2 rounded">
                                        <ConditionBuilder
                                            condition={condition}
                              ...
                              <div>
                                ...
                                <div className="space-y-2">
                                  {rule.actions.map((action, actionIndex) => (
                                      <div key={actionIndex} className="flex items-start space-x-2 bg-gray-50 p-2 rounded">
                                        <ActionBuilder
                                            action={action}
                ...
                <div className="bg-white rounded-lg shadow-md p-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border rounded-lg overflow-hidden">
                      ...
                      >
                        Core Extensions
                        {expandedCategories.core ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                      </button>
                    ...
                    <div className="border rounded-lg overflow-hidden">
                      ...
                      >
                        Action Extensions
                        {expandedCategories.actions ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                      </button>
                    ...
                    <div className="border rounded-lg overflow-hidden">
                      ...
                      >
                        Test Extensions
                        {expandedCategories.tests ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                      </button>
                    ...
                    <div className="border rounded-lg overflow-hidden">
                      ...
                      >
                        Message Extensions
                        {expandedCategories.message ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                      </button>
                    ...
                    <div className="border rounded-lg overflow-hidden">
                      ...
                      >
                        Advanced Extensions
                        {expandedCategories.advanced ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4" />}
                      </button>
              ...
              {extensions.copy && (
                  <div className="flex items-center col-span-1">
                    ...
                    <HelpTooltip text={HELP_TEXT.fileOptions.copy}>
                      <button aria-label="Copy option information" className="ml-1 text-gray-400 hover:text-blue-500">
                        <HelpCircle className="h-4 w-4" />
                      </button>
                    </HelpTooltip>
                  </div>
              ...
              {extensions.mailbox && (
                  <div className="flex items-center col-span-1">
                    ...
                    <HelpTooltip text={HELP_TEXT.fileOptions.create}>
                      <button aria-label="Create option information" className="ml-1 text-gray-400 hover:text-blue-500">
                        <HelpCircle className="h-4 w-4" />
                      </button>
                    </HelpTooltip>
                  </div>
            ...
            <>
              <div className="flex items-center col-span-2">
                ...
                <HelpTooltip text="The email address where the message will be forwarded">
                  <button aria-label="Redirect address information" className="ml-1 text-gray-400 hover:text-blue-500">
                    <HelpCircle className="h-4 w-4" />
                  </button>
                </HelpTooltip>
              </div>
            ...
            <>
              <div className="flex items-center col-span-3">
                ...
                <HelpTooltip text="Explanation sent back to the sender about why their message was rejected">
                  <button aria-label="Rejection reason information" className="ml-1 text-gray-400 hover:text-blue-500">
                    <HelpCircle className="h-4 w-4" />
                  </button>
                </HelpTooltip>
              </div>
        ...
        {action.type === 'vacation' && (
            ...
            />
                <HelpTooltip text={HELP_TEXT.vacationOptions.message} position="right">
                  <button aria-label="Message information" className="ml-1 mt-1 text-gray-400 hover:text-blue-500">
                    <HelpCircle className="h-4 w-4" />
                  </button>
                </HelpTooltip>
              </div>
